...
export function SupportChat() {
  ...
  return <div className={'support-widget '+(open ? 'is-open' : '')}>
    {open && <section className="support-panel" role="dialog" aria-modal="false" aria-label="MIDAS help centre">
      <header className="support-header"><div className="support-brand"><img src="/midas-nobg.webp" alt=""/><div><strong>MIDAS Help Centre</strong><span><i/> Online support</span></div></div><button type="button" onClick={() => setOpen(false)} aria-label="Close help centre">×</button></header>
