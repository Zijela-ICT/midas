...
export function Footer() {
  return <footer className="footer"><div className="container">
    <div className="footer-grid">
      ...
      <div className="footer-contact"><h4>Offices & contact</h4><div className="footer-office"><b>Nigeria office</b><p>24 Adegbola Street, Opposite Railway Line, Ikeja, Lagos State.</p><div className="footer-office-links"><a href="tel:+2348182072342">+234 818 207 2342</a><a href="tel:+2348161640774">+234 816 164 0774</a><a href="mailto:info@shipwithmidas.com">info@shipwithmidas.com</a></div></div><div className="footer-office"><b>United Kingdom office</b><p>98 Hope Street, Leigh WN7 1NP, Greater Manchester, United Kingdom.</p><div className="footer-office-links"><a href="tel:+447858022086">+44 7858 022086</a><a href="mailto:tayo@shipwithmidas.com">tayo@shipwithmidas.com</a></div></div></div>
    </div>
