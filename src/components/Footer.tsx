    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div>
            <img
              ...
              src="/midas-nobg.png"
              alt="Midas Global Solutions Limited"
            />
            <p>
              Moving businesses forward through dependable logistics,
              intelligent supply chains and exceptional service.
            </p>
          </div>
          <div>
            <h4>Explore</h4>
            <div className="footer-links">
              ...
              <a href="/industries" onClick={(e) => go(e, "/industries")}>
                Industries
              </a>
              <a href="/posts" onClick={(e) => go(e, "/posts")}>
                Insights
              </a>
            </div>
          </div>
        ...
        <div className="copyright">
          <span>
            © {new Date().getFullYear()} Midas Global Solutions Limited.
          </span>
